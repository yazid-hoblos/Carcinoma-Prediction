---
title: "Tree-based and Unsupervised Learning Approaches"
author: "Yazid Hoblos"
date: '2022-11-26'
...
The Z score for each shadow feature will be computed, where the Z score is the mean of accuracy loss divided by standard deviation of accuracy loss, and features will be classified as unimportant, important or tentative based on where the importance value falls with respect to the max z-value (shadow max). The logic behind this is that a feature is useful only if it’s capable of doing better than the best randomized (shadow) feature, i.e its importance value is higher than shadow max.
